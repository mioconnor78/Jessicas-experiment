...
kable(PPres, digits=2, col.names = c('Int','Z~j~','T~ij~','T~M~', 'T~ij~*T~M~', 'T~ij~*Z~j~','T~M~*Z~j~', 'df', 'logLik','AICc','d','w'))
```
...
kable(TCres, digits=2, col.names = c('Int','T~M~','Wk','T~M~*Wk','df','logLik','AICc','d','w'))
```
...
```{r Table S2.3}
kable(NPres, digits=2, col.names = c('Int','Z~j~','T~ij~','T~M~', 'T~ij~*T~M~', 'T~ij~*Z~j~','T~ij~*Z~j~', 'df', 'logLik','AICc','d','w'))
```
...
```{r Table S5}
kable(ERres, digits=2, col.names = c('Int','Z~j~','T~M~','T~ij~', 'T~ij~*T~M~', 'T~M~*Z~j~','T~M~*Z~j~', 'df', 'logLik','AICc','d','w'))
```
