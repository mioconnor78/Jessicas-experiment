...
modNPPF <- lme(log(NPP2) ~ 1 + I(log(2*Pcarbon)) + I(invTi - invTT) + trophic.level + trophic.level*I(invTi - invTT) + I(invTT - mean(invTT)) + trophic.level*I(invTT - mean(invTT)) + I(invTi - invTT)*I(invTT - mean(invTT)), random = ~ 1 | Tank, data=data1, method="ML", na.action=na.omit)

modNPPFa <- lme(log(NPP2) ~ 1 + I(invTi - invTT) + trophic.level + trophic.level*I(invTi - invTT) + I(invTT - mean(invTT)) + trophic.level*I(invTT - mean(invTT)) + I(invTi - invTT)*I(invTT - mean(invTT)), random = ~ 1 | Tank, data=data1, method="ML", na.action=na.omit)
```
...
modNPP8 <- lme(log(NPP2) ~ 1 + I(log(2*Pcarbon)) + trophic.level*I(invTi - invTT) + trophic.level*I(invTT - mean(invTT)), random = ~ 1 | Tank, data=data1, method="ML", na.action=na.omit)

modNPP7 <- lme(log(NPP2) ~ 1 + I(log(2*Pcarbon)) + I(invTi - invTT) + trophic.level + trophic.level*I(invTT - mean(invTT)), random = ~ 1 | Tank, data=data1, method="ML", na.action=na.omit)

modNPP6 <- lme(log(NPP2) ~ 1 + I(log(2*Pcarbon)) + trophic.level*I(invTi - invTT), random = ~ 1 | Tank, data=data1, method="ML", na.action=na.omit)

modNPP5 <- lme(log(NPP2) ~ 1 + I(log(2*Pcarbon)) + I(invTi - invTT) + trophic.level, random = ~ 1 | Tank, data=data1, method="ML", na.action=na.omit)

modNPP4 <- lme(log(NPP2) ~ 1 + I(log(2*Pcarbon)) + I(invTi - invTT)*I(invTT - mean(invTT)), random = ~ 1 | Tank, data=data1, method="ML", na.action=na.omit)

modNPP3 <- lme(log(NPP2) ~ 1 + I(log(2*Pcarbon)) + I(invTi - invTT) + I(invTT - mean(invTT)), random = ~ 1 | Tank, data=data1, method="ML", na.action=na.omit)

modNPP2 <- lme(log(NPP2) ~ 1 + I(log(2*Pcarbon)) + I(invTi - invTT), random = ~ 1 | Tank, data=data1, method="ML", na.action=na.omit)

modNPP1 <- lme(log(NPP2) ~ 1 + I(log(2*Pcarbon)) + trophic.level, random = ~ 1 | Tank, data=data1, method="ML", na.action=na.omit)

modNPP0 <- lme(log(NPP2) ~ 1 + I(log(2*Pcarbon)), random = ~ 1 | Tank, data=data1, method="ML", na.action=na.omit)

#model.sel(modNPP0, modNPP1, modNPP2, modNPP3, modNPP4, modNPP5, modNPP6, modNPP7, modNPP8, modNPPF)

NPres <- data.frame(model.sel(modNPP0, modNPP1, modNPP2, modNPP3, modNPP4, modNPP5, modNPP6, modNPP7, modNPP8, modNPPF, modNPPFa))
```
